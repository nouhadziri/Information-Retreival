...
class ClustererSQLiteHandler(AbstractSQLiteHandler):
    ...
    def create_index_tables(self):
        ...
        self.cursor.executescript("""
            ...
            CREATE TABLE IF NOT EXISTS Document (doc_id INT PRIMARY KEY, doc_len REAL);
    ...
    def insert_doc_entry(self, doc_id, doc_len):
        self.cursor.execute("INSERT INTO Document VALUES (?, ?)", (doc_id, doc_len))
    ...
    def load_doc_index(self):
        self.cursor.execute("SELECT doc_id, doc_len FROM Document")
        ...
        for row in docs:
            ...
            doc_dictionary[doc_id] = {'length': doc_len}
